...
// import { RiFileDownload, RiFileTextLine } from 'react-icons/ri';
...
const LeftSide = () => {
          ...
          <h5 className="text-lg font-semibold mb-3">Documents</h5>
          ...
          <div className="ms-3">
          <h6 className="text-base font-medium mb-0">Resume.pdf</h6>
          <p className="text-gray-500 mb-0">1.25 MB</p>
          </div>
          <div className="ms-auto">
          <a href="assets/images/dark-logo.png" download="" className="text-2xl text-gray-500">
          {/* <RiFileDownload /> */}
          </a>
          </div>
          </div>
          ...
          <div className="ms-3">
          <h6 className="text-base font-medium mb-0">Cover-letter.pdf</h6>
          <p className="text-gray-500 mb-0">1.25 MB</p>
          </div>
          <div className="ms-auto">
          <a href="assets/images/dark-logo.png" download="dark-logo" className="text-2xl text-gray-500">
          {/* <RiFileDownload /> */}
          </a>
          </div>
          </div>
          ...
          <div>
          <p className="text-gray-500 break-words mb-0">Email : {user?.email}</p>
          </div>
          </div>
          </li>
          <li className="mb-2">
          ...
          <div>
          <p className="text-gray-500 mb-0">New Caledonia</p>
          </div>
          </div>
          </li>
          </ul>
