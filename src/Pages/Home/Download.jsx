...
const Download = () => {
          return (
          <div className="bg-violet-200 my-4" >
          <section className="py-6 dark:bg-gray-800 dark:text-gray-50">
          <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col justify-center lg:text-left">
          <p className="mb-1 text-sm font-medium tracki uppercase dark:text-violet-400">Get Special Job Alerts</p>
          <h1 className="py-2 text-3xl font-medium leadi title-font">Download Our App Today !</h1>
          </div>
